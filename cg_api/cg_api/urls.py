...
urlpatterns = [
    ...
    # re_path(r'^api/echo/$', api_views.EchoView.as_view()),
    re_path(r'^api-token-auth/', obtain_jwt_token),
    re_path(r'^api-token-verify/', verify_jwt_token),
    re_path(r'^api-register/?$', api_views.RegistrationAPIView.as_view()),
    re_path(r'^user/?$', api_views.UserAPIView.as_view()),
]
